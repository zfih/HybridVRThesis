...
public:
    ...
    virtual bool Load(const char* filename, Matrix4 &mat, Matrix4 &invMat)
    {
        return LoadH3D(filename, mat, invMat);
    }
...
protected:
    ...
    bool LoadH3D(const char *filename, Matrix4 &mat, Matrix4& invMat);
