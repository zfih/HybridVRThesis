...
void GraphicsContext::ClearDepthAndStencil(DepthBuffer& Target, int subDSV)
{
    m_CommandList->ClearDepthStencilView(Target.GetSubDSV(subDSV), D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, Target.GetClearDepth(), Target.GetClearStencil(), 0, nullptr);
}
