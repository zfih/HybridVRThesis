...
namespace MotionBlur
{
    ...
    void GenerateCameraVelocityBuffer( CommandContext& Context, 
        const Math::Matrix4& reprojectionMatrix, float nearClip, 
        float farClip, UINT curCam, bool UseLinearZ = true);
    ...
    void RenderCameraBlur( CommandContext& Context, const Math::Matrix4& reprojectionMatrix, float nearClip, float farClip, UINT curCam, bool UseLinearZ = true);
    ...
    void RenderObjectBlur( CommandContext& Context, ColorBuffer& velocityBuffer, UINT curCam );
}
